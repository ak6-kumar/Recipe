...
export default function Desserts(){
    ...
    const {loading,error,data} = useQuery(FetchDish,{variables:{type:"Desserts"}});
    ...
    const RenderDesserts = data.allDishes.map((dish)=>{
        return(
    ...
    return(
        <div>
        <Meta titleExclusive="Desserts | Recipes.com"  />
        <Navbar/>
        <h1>Desserts</h1>
