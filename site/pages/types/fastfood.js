...
export default function FastFood(){
    ...
    const {loading,error,data} = useQuery(FetchDish,{variables:{type:"FastFood"}});
    ...
    const RenderFastFood = data.allDishes.map((dish)=>{
        return(
    ...
    return(
        <div>
        <Meta titleExclusive="Fast Food | Recipes.com"  />
        <Navbar/>
        <h1>Fast Food</h1>
