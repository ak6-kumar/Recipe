...
export default function Starters(){
    ...
    const {loading,error,data} = useQuery(FetchDish,{variables:{type:"Starters"}});
    ...
    const RenderStarters = data.allDishes.map((dish)=>{
        return(
    ...
    return(
        <div>
        <Meta titleExclusive="Starters | Recipes.com"  />
        <Navbar/>
        <h1>Starters</h1>
